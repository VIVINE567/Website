...
>
  <span
    style={{
      ...styles.channelLabel,
      backgroundColor: "#3D4F2F", // Photo wala green color
      color: "#ffffff",
      padding: "8px 16px",
      borderRadius: "8px",
      fontWeight: 600,
...
>
  <span
    style={{
      ...styles.channelLabel,
      backgroundColor: "#3D4F2F", // Same dark green
      color: "#ffffff",
      padding: "8px 16px",
      borderRadius: "8px",
      fontWeight: 600,
  ...
  <div
    style={{
      ...styles.iconWrapper,
      background: "rgba(42, 108, 165, 0.95)",
    }}
  >
...
>
  ...
  >
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
      <path
        d="M6.62 10.79C8.06 13.62 10.38 15.94 13.21 17.38L15.27 15.32C15.52 15.07 15.88 14.99 16.2 15.09C17.27 15.45 18.42 15.65 19.61 15.65C20.05 15.65 20.42 16.02 20.42 16.46V20.45C20.42 20.89 20.05 21.25 19.61 21.25C10.99 21.25 3.75 14.01 3.75 5.39C3.75 4.95 4.11 4.58 4.55 4.58H8.54C8.98 4.58 9.35 4.95 9.35 5.39C9.35 6.58 9.55 7.73 9.91 8.8C10.01 9.12 9.93 9.48 9.68 9.73L7.62 11.79C7.5 11.91 7.5 12.08 7.62 12.2L6.62 10.79Z"
        fill="white"
      />
    </svg>
  </div>
