...
export const SYNERGY = [
  {
    ...
    desc: 'LBG intercalates into κ-carrageenan helix junctions, producing elastic, cohesive gels far firmer than carrageenan alone. Key application: processed cheese, dairy desserts, meat analogues, wet pet food. Use ratio: κ-carrageenan:LBG 1:1 to 3:1.',
  },
  {
    partners: [
      { label: 'κ-Carrageenan', bg: '#E4EEF8', tx: '#0A3A5A' },
    ...
    desc: 'Potassium ions are the primary activator for κ-carrageenan gelation. Adding 0.1–0.3% KCl to kappa systems significantly increases gel strength and raises the gel melting temperature — exploited in processed meat injection brines and pet food formulations.',
  },
  {
    partners: [
      { label: 'κ-Carrageenan', bg: '#E4EEF8', tx: '#0A3A5A' },
...
export const APP_DETAILS = [
  ...
  {
    icon: '🐾', title: 'Pet Food & Animal Nutrition', color: IC.petfood,
    items: [
      { name: 'Wet Cat & Dog Food — Pâté & Loaf Formats', desc: 'Kappa-carrageenan (SRC/PES, E407a, 0.2–0.4%) is the industry-standard gelling agent for retorted wet pet food in pâté and loaf format. When blended with LBG (0.1–0.3%), it forms the classic pâté gel that binds meat and fish ingredients into a cohesive, sliceable loaf surviving 121°C retort sterilisation — emerging from the can clean-sliced and intact. The κ-carrageenan + LBG system is unrivalled in wet pet food manufacture for performance and cost-efficiency.' },
      { name: 'Wet Pet Food — Chunk-in-Jelly & Chunk-in-Gravy', desc: 'In jelly-format wet pet food, kappa-carrageenan forms the surrounding jelly that holds meat chunks in suspension — providing visual appeal, moisture, and product integrity in the can. In gravy formats, lower carrageenan levels (0.05–0.15%) with starch or xanthan thicken the sauce and provide cling on meat pieces. Both formats rely on carrageenan\'s retort stability and controlled gel formation on cooling.' },
