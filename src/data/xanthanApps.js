...
export const APP_DETAILS = [
  ...
  },
  {
    ...
    items: [
      { name: 'Wet Pet Food — Gravies & Sauces', desc: 'Xanthan gum (0.1–0.3%) thickens gravy and sauce in chunk-in-gravy and chunk-in-sauce wet pet food formats — providing the sauce cling on meat chunks that creates visual appeal and moisture perception in the bowl. Unlike carrageenan (which gels), xanthan provides a stable, pourable-but-clinging sauce viscosity that survives retort processing at 121°C and maintains consistency on cooling. Used with starch for enhanced viscosity in premium pet food sauces.' },
      { name: 'Wet Pet Food — Suspension Stability', desc: 'In canned and pouch wet pet food, xanthan (0.05–0.2%) prevents vegetable, grain, and supplement particle sedimentation during processing and shelf life. Its yield stress network ensures particles remain uniformly distributed in the can contents — critical for products marketed as "with vegetables" or containing visible fruit/vegetable inclusions. Also suspends added vitamins and mineral premixes uniformly in liquid-based pet food systems.' },
      { name: 'Pet Food Broths & Toppers', desc: 'In refrigerated and ambient pet food broths, bone broths, and food toppers, xanthan gum provides body and mouthfeel at very low concentrations (0.02–0.08%) — making thin broths appear more substantial without adding starch or fat. It prevents separation of natural collagen and fat during storage and provides a consistent, pour-from-the-container viscosity for consumer convenience. Compatible with the high salt and mineral content of broth-based pet food formats.' },
