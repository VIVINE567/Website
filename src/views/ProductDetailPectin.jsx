...
import { HERO } from '../data/pectinContent';
import PectinBody from './pectin/PectinBody';
...
export default function ProductDetailPectin({ slug }) {
      ...
      <section className="pb-12 pt-20 px-4 md:px-6 overflow-hidden" style={S.productDetailHero}>
        <div className="max-w-7xl mx-auto w-full">
          <motion.div {...fadeUp(0)} className="flex items-center gap-2 mb-6 uppercase" style={S.productDetailBreadcrumb}>
            ...
            <ChevronRight className="w-3 h-3" style={{ opacity: 0.5 }} />
            <Link href="/products" className="hover:opacity-80 transition-opacity">Hydrocolloids & Gelling Agents</Link>
            <ChevronRight className="w-3 h-3" style={{ opacity: 0.5 }} />
            <span>Pectin (E440)</span>
          </motion.div>
