...
import { HERO } from '../data/xanthanContent';
import XanthanBody from './xanthan/XanthanBody';
...
export default function ProductDetailXanthan({ slug }) {
