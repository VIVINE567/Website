...
import { SPEC_TABLE, GRADES, VISC_CHART } from '../../data/hecSpecs';
    ...
    <section>
      ...
      <motion.div {...fadeUp} className="rounded-md border p-5 md:p-6" style={{ background: 'var(--cream)', borderColor: 'rgba(201,168,76,0.25)' }}>
        ...
        <div className="flex gap-2">
          <div className="relative pb-9 text-[10px] shrink-0" style={{ height: 280, width: 32, fontFamily: "'Raleway', sans-serif", color: 'var(--brown-warm)' }}>
            {ticks.map((t) => (
